...
export const metadata: Metadata = buildPageMetadata({
  title: "All articles",
  description:
    "Long-form articles on engineering, design, product and the craft of building things that last. New writing every week.",
  path: "/blog",
});
    ...
    <main className="mx-auto w-full max-w-shell flex-1 px-4 py-10 sm:px-6">
      ...
      <header className="max-w-2xl">
        <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl">
          Writing worth the read
        </h1>
        <p className="mt-2 text-muted-foreground">
          Essays and practical guides across engineering, design, product and the quieter
          disciplines that hold a product together.
        </p>
      </header>
