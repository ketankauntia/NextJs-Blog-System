...
/** SEO audits flag titles longer than 60 characters. */
export const TITLE_LIMIT = 60;

/** SEO audits flag descriptions shorter than 110 or longer than 160 characters. */
export const DESCRIPTION_MIN = 115;
export const DESCRIPTION_LIMIT = 158;

const BRAND_SUFFIX = ` | ${SITE_NAME}`;
const DEFAULT_OG_IMAGE_PATH = siteConfig.ogImage;
