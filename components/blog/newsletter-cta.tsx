...
export function NewsletterCta() {
  ...
  return (
    ...
    >
      <p className="font-heading text-lg font-semibold">New posts, straight to your inbox</p>
      <p className="mx-auto mt-1 max-w-md text-sm text-muted-foreground">
        One practical article at a time. No spam, unsubscribe whenever you like.
      </p>
